...
rule ValidateTransferFromEffectOnBalances() {
    address $from;
    address $to;
    uint256 $amount;
    ...
    if ($from != $to) {
        ...
        // When $from and $to are the same, the balance change might be net-zero.
        // Still useful to test under this scenario to ensure no unexpected behavior.
