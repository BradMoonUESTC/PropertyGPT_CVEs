...
contract SimplifiedDoftcoin {
    ...
    constructor() public {
        ...
        balanceOf[owner] = totalSupply; // Assigns the entire supply to the owner
        emit Transfer(address(0), msg.sender, totalSupply); // Emits a transfer event for the initial supply
    }
    ...
    function mintToken(address _target, uint256 _mintedAmount) public {
        ...
        emit Transfer(address(0), _target, _mintedAmount); // Emits a transfer event
    }
}
