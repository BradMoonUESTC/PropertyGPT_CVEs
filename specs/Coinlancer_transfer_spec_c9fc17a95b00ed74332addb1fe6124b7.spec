...
precondition{balances[msg.sender] >= _amount && _amount > 0 && (balances[_to] + _amount) > balances[_to]}

postcondition{balances[msg.sender] == __old__(balances[msg.sender]) - _amount && balances[_to] == __old__(balances[_to]) + _amount}
}